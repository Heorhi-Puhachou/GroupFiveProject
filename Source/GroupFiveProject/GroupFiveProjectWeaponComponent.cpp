...
UGroupFiveProjectWeaponComponent::UGroupFiveProjectWeaponComponent()
{
...
bool UGroupFiveProjectWeaponComponent::AttachWeapon(AGroupFiveProjectCharacter* TargetCharacter)
{
	...
	if (Character == nullptr || Character->GetInstanceComponents().FindItemByClass<UGroupFiveProjectWeaponComponent>())
	{
		return false;
	}
	...
	if (APlayerController* PlayerController = Cast<APlayerController>(Character->GetController()))
	{
			...
			PlayerController->InputComponent))
		{
			...
			EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Triggered, this,
			                                   &UGroupFiveProjectWeaponComponent::Fire);
		}
	}
...
void UGroupFiveProjectWeaponComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
